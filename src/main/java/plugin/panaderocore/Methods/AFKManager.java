...
public class AFKManager {
   ...
   public static Team afkTeam() {
      ...
      Team afkTeam = scoreboard.getTeam("prisoner");
      if (afkTeam == null) {
         afkTeam = scoreboard.registerNewTeam("prisoner");
   ...
   public static void checkPlayerStatus() {
      Bukkit.getScheduler().scheduleSyncRepeatingTask(CoreConfig.plugin, () -> {
   ...
   private static boolean isPlayerAFK(Player player) {
      long afkTimeout = CoreConfig.getLong("config.afkTimeout") * 1000;
